...
if __name__ == "__main__":
    llm = CpmBeeLLM(config_path="/data/private/qinyujia/webcpm/cpm_live/config/cpm-bee-10b.json", ckpt_path="/data/private/qinyujia/pretrained_models/cpm_10b_webcpm_exp.pt")
